...
@section ('title', trans('labels.backend.stocks.management') . ' | ' . trans('labels.backend.stocks.dailyConsume'))
...
@section('content')
    {{ Form::model($stock, ['route' => ['admin.stocks.keepStockConsume', $stock], 'class' => 'form-horizontal', 'id'=>'edit-stock-form','role' => 'form', 'method' => 'PATCH']) }}
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                {{ Form::label('default', trans('labels.backend.stocks.expend').":", ['class' => 'col-lg-2 control-label']) }}
