...
@section ('title', trans('labels.backend.customer.management') . ' | ' . trans('labels.backend.customer.change_balance'))
...
@section('content')
    {{ Form::open(['route' => ['admin.customer.changeBalanceStore', $customer], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
    ...
    <div class="box box-success">
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to(URL::previous(), trans('buttons.general.cancel'), ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
