...
@section ('title', trans('labels.backend.goodCategory.management') . ' | ' . trans('labels.backend.goodCategory.edit'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.goodCategory.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($goodCategory, ['route' => ['admin.goodCategory.update', $goodCategory], 'class' => 'form-horizontal', 'id'=>'edit-goods-form','role' => 'form', 'method' => 'PATCH']) }}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.goodCategory.edit') }}</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('name', $goodCategory->name, ['class' => 'form-control', 'required', 'placeholder' => trans('validation.attributes.backend.goods.name')]) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::select('shop_id', $shops, $goodCategory->shop_id, ['class' => 'form-control', 'required']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
        </div><!-- /.box-body -->
    </div><!--box-->
