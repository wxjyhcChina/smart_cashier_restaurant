...
namespace App\Modules\Models\GoodCategory\Traits\Attribute;

/**
 * Trait GoodsAttribute
 * @package App\Modules\Models\GoodCategory\Traits\Attribute
 */
trait GoodCategoryAttribute
{
    /**
     * @return string
     */
    ...
    {
        return '<a href="' . route('admin.goodCategory.edit', $this, false) . '" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . trans('buttons.general.crud.edit') . '"></i></a> ';
    }
