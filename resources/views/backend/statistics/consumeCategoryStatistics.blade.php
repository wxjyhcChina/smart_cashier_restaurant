...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.statistics.consumeCategoryStatistics') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.statistics.consumeCategoryStatistics') }}</h3>
        </div><!-- /.box-header -->
    ...
    <script>
        $(function() {
            ...
            var table = $('#consume-order-table').DataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.statistics.getConsumeCategoryStatisticsOrder") }}',
                    data: function ( d ) {
                ...
                columns: [
                    ...
                    {data: 'consume_category_name', name: 'categories.name'},
