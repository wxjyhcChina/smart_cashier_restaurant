...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.statistics.goodsStatistics') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.statistics.goodsStatistics') }}</h3>
        </div><!-- /.box-header -->

        <div class="box-body">
            {{ Form::open(['route' => 'admin.statistics.goodsStatisticsExport', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
    ...
    <script>
        $(function() {
            ...
            function getSearchResult() {
                ...
                $.ajax({
                    type: "GET",
                    url: '{{ route("admin.statistics.getGoodsStatistics") }}',
                    data: {
