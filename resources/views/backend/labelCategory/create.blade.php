...
@section ('title', trans('labels.backend.labelCategory.management') . ' | ' . trans('labels.backend.labelCategory.create'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.labelCategory.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.labelCategory.store', 'class' => 'form-horizontal', 'role' => 'form', 'id'=>'store-label-category-form', 'method' => 'post']) }}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.labelCategory.create') }}</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => trans('validation.attributes.backend.labelCategory.name')]) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
