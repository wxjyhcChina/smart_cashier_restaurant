...
@section ('title', trans('labels.backend.customer.management') . ' | ' . trans('labels.backend.customer.lost_card'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.customer.management') }}
        <small>{{ trans('labels.backend.customer.lost_card') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($customer, ['route' => ['admin.customer.doLostCard', $customer], 'class' => 'form-horizontal', 'id'=>'edit-customer-form','role' => 'form', 'method' => 'PATCH']) }}


    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.customer.lost_card') }}</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                {{ Form::label('card_id', trans('validation.attributes.backend.customer.new_card').":", ['class' => 'col-lg-2 control-label']) }}

                <div class="col-lg-10">
                    {{ Form::text('card', "", ['class' => 'form-control', 'id'=>'card', 'required', 'placeholder' => trans('validation.attributes.backend.customer.card')]) }}
    ...
    <div class="box box-info">
        <div class="box-body">
            ...
            <div class="pull-right">
                {{ Form::submit(trans('buttons.backend.customer.lost'), ['class' => 'btn btn-success btn-xs']) }}
            </div><!--pull-right-->
